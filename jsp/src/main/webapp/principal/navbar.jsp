              ...
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="<%= request.getContextPath() %>/principal/principal.jsp">
                          <img class="img-fluid" src="<%= request.getContextPath() %>/assets/images/logoCFRdoCarmo.png" alt="Theme-Logo" />
                      </a>
                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="<%= request.getContextPath() %>/assets/images/fotoFelipe2.jpg" alt="Generic placeholder image">
                                          <div class="media-body">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="<%= request.getContextPath() %>/assets/images/fotoFelipe2.jpg" class="img-radius" alt="User-Profile-Image">
